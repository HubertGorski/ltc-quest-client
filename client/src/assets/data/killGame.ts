...
export const killGameData = {
    ...
    usersAlive: 17,
    cards: [
        new KillGameCard(1,1,"Oskar Litka",'Spirit', 'Zrób słowiański przykuc', KILL_GAME_CARD_STATUS.INACTIVE),
        new KillGameCard(2,1,"Amadeusz Hyży",'Szkolenie', 'Zaśpiewaj coś z disneya', KILL_GAME_CARD_STATUS.INACTIVE, 1),
        new KillGameCard(2,1,"Stanisław Kot",'Ogarniam', 'Poprowadź grupową grę dla conajmniej 10 uczestników', KILL_GAME_CARD_STATUS.INACTIVE),
        new KillGameCard(3,1,"Klara Orłowska",'Ognisty krąg', 'Zrób tosta', KILL_GAME_CARD_STATUS.EXPECTANCY, 2, 'Laura Chrzanowska')
    ]
}