...
export const killGameData = {
    ...
    usersAlive: 17,
    cards: [
        new KillGameCard(1,1,"Oskar Litka",'Spirit', 'Zrób słowiański przykuc', KILL_GAME_CARD_STATUS.EXPECTANCY),
        ...
        new KillGameCard(3,1,"Klara Orłowska",'Ognisty krąg', 'Zrób tosta', KILL_GAME_CARD_STATUS.INACTIVE, 2, 'Laura Chrzanowska')
    ]
}